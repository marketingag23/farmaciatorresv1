  ...
  return (
    ...
    >
      <div className="grid justify-items-center px-auto py-52">
        ...
        >
          <path
            d="M54.274 10.196L49.325 15.2628C45.3172 11.1592 40.0436 8.60522 34.4027 8.0361C28.7619 7.46699 23.1028
             8.91793 18.3897 12.1417C13.6766 15.3655 10.2011 20.1626 8.55539 25.7158C6.90968 31.269 7.19559 37.2345 
             9.36438 42.5961C11.5332 47.9576 15.4507 52.3834 20.4494 55.1193C25.4481 57.8552 31.2188 58.732 36.7781 
             57.6002C42.3375 56.4685 47.3415 53.3982 50.9377 48.9126C54.5339 44.4269 56.4996 38.8035 56.5 33.0003H63.5C63.5 
             40.4615 60.973 47.6919 56.3497 53.4594C51.7264 59.227 45.2928 63.1749 38.1451 64.6304C30.9974 66.086 23.5779
              64.9591 17.1508 61.4419C10.7237 57.9247 5.68654 52.2347 2.89771 45.3414C0.108886 38.4481 -0.259102 30.7781
               1.85645 23.6382C3.97201 16.4982 8.44021 10.3302 14.4997 6.18503C20.5592 2.03985 27.8352 0.17399 35.0878 
               0.905363C42.3403 1.63674 49.1209 4.9201 54.274 10.196V10.196Z"
            fill="#0F51FA"
          />
        </svg>
      </div>
...
export default function Dpartamentofilter({
  ...
  params: { departamento: string; ciudad: string };
}) {
  ...
  return isLoading ? (
    ...
    <>
      <Breadcrumbs
        Categoria={params.departamento}
        UrlCategoria={`/farmacias/${params.departamento}`}
        Subcategoria={params.ciudad}
        UrlSubcategoria={`/farmacias/${params.departamento}/${params.ciudad}`}
      />
